...
export interface TranslationDict {
  ...
  projectManagement: {
    ...
    openIssues: string;
    drawerProject: string;
    drawerTimeline: string;
    drawerMilestone: string;
    drawerEdit: string;
    drawerSave: string;
    drawerSaving: string;
    drawerCancel: string;
    ...
    drawerNote: string;
    drawerKeyResources: string;
    drawerSectionOverview: string;
    drawerSectionInformation: string;
    drawerSectionTeam: string;
    drawerSectionBasicInformation: string;
    drawerSectionPlan: string;
    drawerSectionRelations: string;
    drawerSectionMilestones: string;
    ...
    drawerStatusInProgress: string;
    drawerStatusCompleted: string;
    drawerStatusAtRisk: string;
    drawerStatusDelayed: string;
    drawerStatusBlocked: string;
    drawerStatusPaused: string;
    drawerOpenDetails: string;
    ...
    createNext: string;
    createSkip: string;
    createStepsLabel: string;
    createSkeletonHelp: string;
    createPlanHelp: string;
    createUnset: string;
    createLifecyclePhase: string;
    createLifecycleConcept: string;
    createLifecycleDevelopment: string;
    createLifecycleValidation: string;
    createLifecycleProduction: string;
    createLifecycleMaintenance: string;
    createSummary: string;
    createPriority: string;
    createPriorityLow: string;
    createPriorityMedium: string;
    createPriorityHigh: string;
    createCustomer: string;
    createVehicleModel: string;
    createProjectType: string;
    createTypeDevelopment: string;
    createTypeMatching: string;
    createProjectManagerOptional: string;
    createNoProjectManager: string;
    createNoPersonsOption: string;
    createNoPersonsHelp: string;
    createDefaultMemberLabel: string;
    createInitialTeam: string;
    createInitialTeamHelp: string;
    createNoInitialMembers: string;
    createInitialMilestones: string;
    createNoInitialMilestones: string;
    createAddMilestone: string;
    createMilestoneNumber: string;
    createTimelineRelation: string;
    createYdInternal: string;
    createStageGate: string;
    deleteAction: string;
  ...
  projectManagementPortal: {
    ...
    deletePersonTitle: string;
    deletePersonWarning: string;
  };
